    ...
    <div class="col-md-12 padding-0 form-element" style="width:1000px; margin-left:10px;">
      <!-- 搜索 -->
		<div class="index-wall white " style="length:200px;height:100px;">
			<form class="form-inline" action="../DeleteCar" method="post" >
					...
					<button type="submit" class="btn btn-warning mar-left-10" style="background-color:#C45D2B;position:absolute;left:620px;margin-top:5px;">Delete Car</button>
				</form>
		</div>
	<!-- 搜索结束 --> 
    </div>
