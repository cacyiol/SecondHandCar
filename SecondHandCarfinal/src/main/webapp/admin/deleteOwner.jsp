...
<body>
   ...
   <div class="panel">
		<div class="panel-body">
			<div class="col-md-12">
				<h3 class="animated fadeInLeft">delete Owner</h3>
			</div>
		</div>
		<div id="right">
				<div id="right_top">
    ...
    <div class="col-md-12 padding-0 form-element" style="width:1000px; margin-left:10%;">
      <!-- 搜索 -->
		<div class="index-wall white " style="length:200px;height:100px;">
			<form class="form-inline" action="../DeleteOwner" method="post" >
					<div class="form-group mar-left-10" style="height:40px;color:black;">
						 <select style="width:180px;position:absolute;left:280px;margin-top:3px;font-size:1px;padding-left:1px;px;" name="delete_type">
       				 		 ...
       				 		 <option value="3">drivingLisenceNumber</option>
   						 </select>
					...
					<button type="submit" class="btn btn-warning mar-left-10" style="background-color:#C45D2B;position:absolute;left:620px;margin-top:5px;">Delete Owner</button>
				</form>
		</div>
	<!-- 搜索结束 --> 
    </div>
